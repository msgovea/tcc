...
public class AsyncImpulsionarPublication extends AsyncTask<Long, String, String> {


    public interface Listener {
        void onLoadedImpuls(Boolean bool);
        void onLoadedError(String s);
    }

    private Listener mListener;

    public AsyncImpulsionarPublication(Listener mListener) {
    ...
    protected String doInBackground(Long... n) {
        ...
        try {
            ...
            URL url = new URL(API.URL + API.PUBLICATION_IMPULS + n[0]);
            urlConnection = (HttpURLConnection) url.openConnection();
            urlConnection.setDoOutput(true);
            urlConnection.setRequestMethod("GET");

            Log.e("Impulsionar Publicação", url.toString());
