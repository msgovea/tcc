...
public class QuestionsAdapterHigh extends RecyclerView.Adapter<QuestionsAdapterHigh.ViewHolder> {
    ...
    public QuestionsAdapterHigh(Context context, List<Publicacao> questions) {
        mContext = context;
